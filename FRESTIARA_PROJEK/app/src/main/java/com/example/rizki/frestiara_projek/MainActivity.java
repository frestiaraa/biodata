package com.example.rizki.frestiara_projek;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void openmaps(View v){
        ...
        Uri uri = Uri.parse("https://www.google.com/maps/search/pekalongan/@-6.912418, 109.667761");
    ...
    public void openemail(View v){
        ...
        i.putExtra(Intent.EXTRA_EMAIL  , new String[]{"frestiara71@gmail.com"});
        try {
